class BotaoView extends View {
  ...
  template(model) {
    ...
    return `<button class="btn btn-primary" type="submit"" ${StringHelper.splitString(model.texto, 0)}>Solicitar Corrida</button>
                <button class="btn btn-primary" type="submit" onclick="negociacaoController.iniciaCorrida(event)" ${StringHelper.splitString(model.texto, 1)}>Confirmar Corrida</button>
